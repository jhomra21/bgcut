...
This file records the concrete improvements that should move `removebg-webgpu` from a working local background remover into a differentiated GPU-native cutout engine and editor.
