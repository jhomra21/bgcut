...
The [documentation index](docs/README.md) maps the repository documentation. [Benchmarks](docs/engineering/benchmarks.md) record measured runtime results, [graph-capture notes](docs/engineering/graph-capture.md) document the current browser fast path, the [roadmap](docs/engineering/roadmap.md) tracks planned work, and the [deployment guide](docs/operations/deploying.md) covers Cloudflare.
